...
\subsubsection{Strumenti}
	...
	\end{itemize}
		...
		\subparagraph{Stesura dei diagrammi}
		
		I software utilizzati per la stesura dei diagrammi sono i seguenti:
		\begin{itemize}
			\item \textbf{Draw.io:} applicazione online per la realizzazione di organigrammi;
			\item \textbf{GanttProject:} applicazione open source per la realizzazione di diagrammi di gantt che visualizzano lo svolgimento delle attività.
		\end{itemize}
