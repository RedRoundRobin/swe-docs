...
\subsection{Gestione dei Processi}
	...
	\subsubsection{Attività}
		...
		\textbf{Verificatore: }
			...
			\textbf{QM-PROC-1. Budgeted Cost of Work Scheduled (BCWS): } \\
			...
			\textbf{QM-PROC-2. Actual Cost of Work Performed (ACWP): } \\
			...
			\textbf{QM-PROC-3. Budgeted Cost of Work Performed (BCWP): } \\
			...
			\textbf{QM-PROC-4. Schedule Variance (SV): } \\
			...
			\textbf{QM-PROC-5. Cost Variance (CV): } \\
      ...
      In modo più informale, infine, si fa anche uso di una chat di \textbf{Telegram} per coordinarsi su eventuali cambi di luogo o per discutere di argomenti extra-lavorativi.
		...
		\subparagraph{Gestione dei Rischi (QP-2)}
			...
			\textbf{QM-PROC-6. Unbudgeted Risks (UR)}
