...
\subsection{Gestione dei processi}
	...
	\subsubsection{Descrizione}
		Le attività previste dal processo di gestione dei processi sono raccolte nel \dext{Piano di Progetto v2.0.0}, la cui redazione è in carico al responsabile, con la collaborazione dell'amministratore.
		\newline
	...
	\subsubsection{Strumenti}
		...
		\begin{itemize}
			...
			\item \textbf{\glock{Discord}:} applicativo gratuito che offre la possibilità di creare dei canali vocali e testuali per svolgere degli incontri virtuali con il gruppo;
