...
\subsection{Capitolato C4 - Predire in Grafana}
		...
		\subsubsection{Finalità del progetto}
			È richiesto lo sviluppo di due \glock{plug-in} per Grafana che siano in grado di predire un possibile stato dell'imminente futuro della macchina. La predizioni devo essere effettuate tramite \glock{Regressione Lineare} (RL) e/o \glock{Support Vector Machine} (SVM).
		...
		\subsubsection{Tecnologie interessate}
			...
			\begin{itemize}
			  ...
			  \item \textbf{\glock{Regressione Lineare} (RL):} modello di predizione basata sulla differenza dei quadrati che genera una predizione lineare del tipo \(y=ax+b\);
				...
				\item \textbf{\glock{JMeter}:} \glock{suite} di generazione di dati virtuali per l'addestramento;
		...
		\subsubsection{Criticità}
			\begin{itemize}
				...
				\item necessita uno studio approfondito della documentazione di varie \glock{suite} e programmi per poter avere un'idea più concreta del progetto.
			\end{itemize}
