...
\section{Valutazione capitolato scelto}
	...
	\begin{itemize}
		...
		\item \textbf{\glock{Docker}:} tecnologia di \glock{containerizzazione} che consente la creazione e l'utilizzo di container. Nel progetto risulterebbe utile per l'instanziazione di tutti i componenti;
	...
	Il capitolato ha suscitato l'interesse del gruppo, dando la possibilità di ampliare tecnologie già in parte conosciute ed al contempo molto attuali, quali \glock{IoT} e \glock{Big Data}. C'è stato inoltre molto entusiasmo per la tipologia di \glock{web-application} da sviluppare. Nell'insieme questo capitolato è stato accolto con forte interesse da tutti i componenti del gruppo.
