\subsection{Capitolato C2 - Etherless}
	...
	\subsubsection{Linguaggi di programmazione}
        	\begin{itemize}
        		...
        		\item \textbf{\glock{Solidity}: }è un linguaggio tipato staticamente che supporta l'eredità, librerie e tipi definiti dall'utente. Viene utilizzato per scrivere smart contracts;
