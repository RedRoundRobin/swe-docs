...
\section*{Svolgimento}
	...
	\subsection*{Scegliere quali tecnologie utilizzare per la realizzazione del prodotto software}
		...
		\begin{itemize}
				...
				\item per la realizzazione della \glock{webapp} lato server si è deciso di usare \glock{php};
				\item per implementare l'interfaccia della webapp e il suo comportamento conseguente all'interazione con gli utenti, si è deciso di utilizzare \glock{xhtml strict},
