...
\section*{Svolgimento}
	...
	\subsection*{Richiesta di conferma per l'appuntamento con il proponente per il giorno 2020-02-26}
		...
		\newline
		L'appuntamento era fissato per il 2020-02-26, ore 16:00 in sede del proponente. A seguito dell'annuncio dell'epidemia che si è diffusa nel Padovano, il proponente ha preferito rimandare la data dell'appuntamento e ci ha proposto, in alternativa, di realizzare, nel corso della settimana, un \textbf{video} per mostrare il \glock{proof of concept} fino ad ora realizzato, così da stimolare lo \textit{Smart Working}.
		\newline
