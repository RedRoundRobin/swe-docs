		...
		\subsubsection{Periodi}
			...
			\paragraph{Secondo periodo (dal 2019-12-07 al 2019-12-16):}
				...
				\begin{itemize}
					...
					\item \textbf{Normazione:} discussione interna al gruppo circa le regole da adottare durante lo sviluppo del progetto. Continuazione della stesura del documento \dext{Norme di Progetto}, in particola le sezioni riguardanti i processi primari e processi organizzativi;
					\item \textbf{Analisi di qualità:} analisi preliminare riguardante le metriche da utilizzare per controllare e garantire la qualità del prodotto;
