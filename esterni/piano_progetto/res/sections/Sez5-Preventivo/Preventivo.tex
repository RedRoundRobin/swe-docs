\section{Preventivo}
	...
	I successivi quattro incrementi, che vedremo in dettaglio, comporranno la fase stessa.  
		...
		\begin{figure}[H]
			...
			\caption{Grafico percentuale ore/ruolo dei primi quattro incrementi}
			\label{fig:grafico costi ruolo incrementi I-IV}
		\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{Grafico percentuale ore/ruolo dal quinto all'ottavo incremento}
		\label{fig:grafico costi ruolo incrementi V-VIII}
	\end{figure}	
	...
	\begin{figure}[H]
		...
		\caption{Grafico ore/ruolo componenti negli ultimi quattro incrementi}
		\label{fig:grafico suddivione ruoli incrementi IX-XII}
	\end{figure}
	\pagebreak
	...
	\begin{figure}[H]
		...
		\caption{Grafico percentuale ore/ruolo degli ultimi quattro incrementi}
		\label{fig:grafico costi ruolo incrementi IX-XII}
	\end{figure}
	\pagebreak
