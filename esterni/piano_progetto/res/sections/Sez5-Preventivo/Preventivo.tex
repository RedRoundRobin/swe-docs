\section{Preventivo}
	...
	\subsection{Fase di Analisi}
		\subsubsection{Prospetto orario}
			...
			\begin{longtable}{|c|c|c|c|c|c|c|c}
				...
				\hline 
				\caption{Tabella contenente il prospetto orario preventivato per il periodo di analisi}
			\end{longtable}
			\pagebreak
	...
	\subsection{Fase di Progettazione dell'architettura}
		...
		\begin{longtable}{|c|c|c|c|c|c|c|c}
			...
			\hline
			\caption{Tabella contenente il prospetto orario preventivato per il periodo di progettazione dell'architettura}
		\end{longtable}
		\pagebreak
