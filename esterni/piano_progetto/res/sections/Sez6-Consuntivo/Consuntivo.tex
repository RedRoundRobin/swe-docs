...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		Le ore di lavoro svolte in questo periodo sono volte all'implementazione completa delle \glock{API} e all'aggiunta di una nuova configurazione del \glock{gateway} con \glock{Kafka};
		\paragraph{Prospetto orario}
		Nella tabella in seguito viene illustrato il cambiamento nel numero d'ore di ogni persona, per ogni ruolo ricoperto:
		...
		Le ore di lavoro svolte in questo periodo sono volte all'implementazione dell'invio di input con il \glock{bot Telegram} e alla parte amministratore della web app;
		\paragraph{Prospetto orario}
		Nella tabella in seguito viene illustrato il cambiamento nel numero d'ore di ogni persona, per ogni ruolo ricoperto:
		...
		\paragraph{Conclusioni}
		Nonostante il dodicesimo incremento fosse il più impegnativo, il gruppo ha mantenuto il numero di ore stabilite, limitando i cambiamenti per ogni ruolo, frutto anche dell'esperienza acquisita nella totale durata del progetto. Nella codifica dei comandi inviabili dal \glock{bot Telegram} sono state necessarie due ore in più per il ruolo del programmatore, in quanto si è dovuto inserire delle istanze \glock{Axios} per gestire al meglio le richieste inviate dagli utenti. Nonostante le variazioni orarie avvenutosi il consuntivo rimane in linea con quanto preventivato.
		...
		\begin{longtable}{|l|c|c|c|c|c|c|c|}
			...
			\hline
			\hline
			Alessandro Tommasin    & 3 (-2) & 0 & 3  & 3 (-1) & 3 (+3) & 4 (+1) & 16 (+1)\\
			\hline
			\hline
		...
		\begin{longtable}{|l|c|c|c|c|c|c|c|}
			...
			\hline
			Responsabile 	    & 12 (-3) & 360,00 (-90,00)\\
			\hline 
			\hline
			...
			\hline
			\hline
			Programmatore 	  & 26 (+8) & 390,00 (+120,00)\\
			\hline
			\hline
			Verificatore 		   & 34 (+9) & 510,00 (+135,00)\\
			\hline
			\textbf{Totale} 	 & 112 (+7 )& 2.162,00 (+23,00)\\
			\hline
			\caption{Tabella contenente il prospetto economico in riferimento al prospetto orario}
		\end{longtable}
		\pagebreak
		...
		\begin{longtable}{|l|c|c|c|c|c|c|c|}
			...
			\hline
			\hline
			Alessandro Tommasin    & 16 (-4) & 9 & 28 (+3) & 25 (-3) & 23 (+5) & 38 & 139 (+1)\\
			\hline
			\hline
			Giovanni Vidotto 			 & 8 & 16 (-3) & 17 (+1) & 29 (+3) & 31 (+2) & 38 (-2) & 139 (+1)\\
			\hline 
			\textbf{Totale}				 & 82 (-8) & 97 (-11) & 146 (+7) & 168 & 183 (+9) & 297 (+10) & 973 (+7)\\
			\hline
		...
		\begin{longtable}{|l|c|c|c|c|c|c|c|}
			...
			\hline
			Responsabile 	    & 82 (-8) & 2.460,00 (-240,00)\\
			\hline 
			\hline
			...
			\hline
			\hline
			Programmatore 	 & 183 (+9) & 2.745,00 (+135,00)\\
			\hline
			\hline
			Verificatore 		  & 297 (+10) & 4.455,00 (+150,00)\\
			\hline
			\textbf{Totale} 	& 973 (+7) & 18.946,00 \\
			\hline
			\caption{Tabella contenente il prospetto economico in riferimento al prospetto orario}
		\end{longtable}
		...
		\begin{longtable}{|l|c|c|c|c|c|c|c|}
			...
			\hline
			\hline
			Alessandro Tommasin    & 7 (-2) & 9 & 11 & 25 (-3) & 23 (+5) & 29 (+1) & 104 (+1)\\
			\hline
			\hline
		...
		\begin{longtable}{|l|c|c|c|c|c|c|c|}
			...
			\hline
			Responsabile 	    & 56 (-3) & 1.680,00 (-90,00)\\
			\hline 
			\hline
			...
			\hline
			\textbf{Totale} 	& 728 (+7) & 13.801,00 (+15,00)\\
			\hline
			\caption{Tabella contenente il prospetto economico in riferimento al prospetto orario}
		\end{longtable}
		...
		Il costo totale per lo sviluppo del progetto ammonta a 13.801,00 €.
	 	...
	 	\subsection{Tabella riassuntiva del preventivo a finire}
			 ...
			 \begin{longtable}{|l|c|c|c|}
				...
				\endfirsthead
			 	...
			 	\hline
		 		\hline
			 	Validazione e collaudo & 2.139,00 & 2.162,00 & +23,00\\
			 	\hline
			 	\textbf{Totale rendicontato} & 13.786,00 & 13.801,00 & +15,00\\
			 	\hline
			 	\hline
			 	\textbf{Totale} & 18.946,00 & 18.946,00 & -\\
			 	\hline
