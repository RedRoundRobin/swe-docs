...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\paragraph{Preventivo a finire}
			Lo sviluppo procede bene, le difficoltà riscontrate sono state in linea con quanto preventivato. Anche in questo caso lo sviluppo della webapp è stato stimolante per i programmatori. Considerando la tendenza positiva avvenutasi fino a questo momento, siamo fiduciosi per i prossimi due incrementi, nonostante siano più corposi necessitino di maggiori risorse temporali.
