	...
	\subsection{Fase di Analisi}
		...
		\subsubsection{Prospetto economico}
			...
			\begin{figure}[H]
				...
				\label{fig:grafico costi ruoloIncremento I }
			\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\subsubsection*{Conclusioni}
			...
			\begin{itemize}
				\item \textbf{Responsabile:} sono state impiegate meno ore rispetto a quelle preventivate in quanto nel Piano di Progetto e nell'approvazione dei documenti sono stati riscontrate meno difficoltà del previsto;	  \item \textbf{Progettista:} Sono state richieste più ore di quelle preventivate poichè il gruppo ha riscontrato alcune difficoltà nello svolgimento di questo ruolo;
