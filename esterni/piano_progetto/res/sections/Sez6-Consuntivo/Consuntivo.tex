\section{Consuntivo di periodo}
	...
	\subsection{Fase di analisi dei requisiti}
		...
		\subsubsection{Preventivo a finire}
			Nonostante alcuni ruoli abbiano subito dei cambiamenti orari, il totale delle ore è rimasto invariato. Questo, aggiunto alla non rendicontazione della fase di analisi dei requisiti, ha portato il gruppo alla decisione di non modificare il preventivo.
		...
		\subsubsection{Preventivo a finire}
			Alla luce dei lievi aggiustamenti ed alla non rendicontazione delle fasi precedenti, il gruppo ha deciso di non modificare il preventivo.	
		...
		\subsubsection{Conclusioni}
			...
			\begin{itemize}
				...
				\item \textbf{verificatore: }si è deciso di aggiungere un'ora di verifica aggiuntiva per ricontrollare i documenti \dext{Piano di progetto} e \dext{Piano di qualifica} alla luce delle modifiche datte in seguito alle osservazioni fatte da parte del committente .
			\end{itemize}
		...
		\subsubsection{Preventivo a finire}
			A seguito dei cambiamenti riportati, nonostante alcuni lievi modifiche all'assegnazione oraria dei ruoli e un piccolo risparmio per il committente sul costo totale del progetto, il gruppo ha deciso di lasciare invariato il preventivo stipulato.	
		...
		\subsubsection{Conclusioni}
			...
			\begin{itemize}
				\item \textbf{amministratore: } la configurazione degli strumenti da parte dell'amministratore ha rischiesto meno tempo di ciò che era stato preventivato.
				\item \textbf{progettista: } grazie all'analisi approfondita svolta nelle fase precendenti per quanto riguarda l'architettura del sistema, il ruolo del progettista ha richiesto un'ora in meno di ciò che era stato preventivato.
		...
		\subsubsection{Preventivo a finire}
			A seguito dei lievi cambiamenti riportati, il gruppo ha deciso di non modificare il preventivo in quanto si è ritenuto che la pianificazione svolta sino al periodo attuale garantisca il raggiungimento degli obiettivi preposti nei tempi stabiliti.	
		...
		\subsubsection{Prospetto economico}
			...
			\begin{itemize}
				...
				\item \textbf{progettista: }la progettazione delle API ha richiesto un'ora in più del ruolo di progettista per creare la struttura base delle API stesse;
				\item \textbf{programmatore: }la complessità delle API e l'uso del framework utilizzato ha fatto si che fosse necessaria un'ora in più del ruolo di programmatore;
