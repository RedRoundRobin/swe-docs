...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		...
		\subsubsection{Riepilogo prospetto orario}
			...
			\begin{figure}[H]
				...
				\caption{Grafico ore/ruolo componenti nei primi quattro incrementi}
				\label{fig:grafico suddivione ruoli incrementi I-IV}
			\end{figure}
			\pagebreak
			...
			\begin{figure}[H]
				...
				\caption{Grafico consuntivo  percentuale ore/ruolo dei primi quattro incrementi}
				\label{fig:grafico consuntivo costi ruolo incrementi I-IV}
			\end{figure}
		\subsubsection{Preventivo a finire}
		In generale, in questa prima parte, lo sviluppo procede secondo quanto preventivato e rispettando le ore prefissate e i cambiamenti orari, di conseguenza, sono stati minimi.
		\newline
		Il gruppo ha risparmiato 15,00 €.
		...
		\begin{figure}[H]
			...
			\caption{Grafico ore/ruolo componenti dal quinto all'ottavo incremento}
			\label{fig:grafico suddivione ruoli incrementi V-VIII}
		\end{figure}
		\pagebreak
		...
		\begin{figure}[H]
			...
			\caption{Grafico consuntivo percentuale ore/ruolo dal quinto all'ottavo incremento}
			\label{fig:grafico consuntivo costi ruolo incrementi V-VIII}
		\end{figure}
		\pagebreak
		\subsubsection{Preventivo a finire}
		In generale, in questa seconda parte, lo sviluppo procede secondo quanto preventivato e rispettando le ore prefissate e i cambiamenti orari, di conseguenza, sono stati limitati ma con un maggior peso a livello economico.
		\newline
		Il gruppo ha sforato il preventivo di 15,00 €.	
		
		
		\subsection{Sviluppo della web app e raffinamento componenti}
		...
		\begin{figure}[H]
			...
			\label{fig:consuntivo grafico suddivisione ruoli incremento IX}
		\end{figure}
