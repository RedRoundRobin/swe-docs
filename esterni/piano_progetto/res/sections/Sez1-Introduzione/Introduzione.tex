\section{Introduzione}
	...
	\subsection{Scadenze}
		...
		\begin{itemize}
			\item \textbr{Revisione dei Requisiti}: 21 Gennaio 2020;
			\item \textbr{Revisione di Progettazione}: 16 Marzo 2020;
			\item \textbr{Revisione di Qualifica}: 18 Maggio 2020;
			\item \textbr{Revisione di Accettazione}: 18 Giugno 2020.
		\end{itemize}
