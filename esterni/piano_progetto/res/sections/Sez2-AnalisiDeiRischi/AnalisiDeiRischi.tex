...
\begin{center}
	...
	che molti componenti del gruppo non conoscono, e questo è
	...
	RSK-RAT-003 \newline  Stime dei costi del progetto
	 & 
	Questo è il primo progetto che richiede al team di fare una stima sui costi di realizzazione del prodotto finale, pertanto il rischio di non rientrare nel range preventivato e' presente.
	& 
	...
	& In maniera costruttiva, il \textit{responsabile}
	   cercherà di parlare con i colleghi che siano stati irriperibili per un lasso di tempo significativo, in modo di cercare di evitare si ripresentino queste spiacevoli situazioni in futuro. \\
	\hline
	
			\hline
	RSK-TBT-009 \newline Malfunzionamenti hardware o software dei pc dei membri del gruppo
	 & 
	Pu succedere che qualcuno abbia il pc malfunzionante e non possa contribuire attivamente alla realizzazione del prodotto.
	&   
