...
\begin{itemize}
	...
	\item \textbf{Prima implementazione completa dell'architettura e aggiunta funzionalità alle componenti (da incremento V a incremento VIII):} verrà fatta un'implementazione base delle componenti restanti, ottenendo quindi un'architettura completa e,  allo stesso tempo, verranno aggiunte ulteriori funzionalità alla componenti precedentemente già sviluppate, ottenendo cosi un maggiore dialogo tra le varie parti fulcro dell'architettura;
	
	\item \textbf{Sviluppo della web app e raffinamento componenti (da incremento IX a incremento XII):} durante questi incrementi le risorse temporali verranno concentrate sullo sviluppo della web app, componente più oneroso e richiedente di un maggior tempo di sviluppo. Verrà realizzata la parte moderatore e utente in modo completo, con tutte le funzionalità e con il soddisfacimento dei requisiti. Verranno inoltre raffinate tutte le funzionalità delle componenti coinvolte nell'architettura, con l'obbiettivo di ottenere un prodotto completo.
	\pagebreak
\end{itemize}
