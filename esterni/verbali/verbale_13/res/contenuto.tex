...
\section*{Svolgimento}
	...
	\subsection*{Fatta prima bozza degli incrementi da attuare durante il processo di sviluppo}
		...
		avere un \glock{POC} funzionante da presentare alla \glock{RP} e riuscire a implementare il prodotto finito entro la prima revisione d'accettazione disponibile.
