\section{Tecnologie interessate}
	...
	\subsection{Framework e librerie}
		...
		\subsubsection{Spring}
			Il framework \glock{Spring} è stato utilizzato per lo sviluppo della componente \glock{API}. Più precisamente dell'intera suite sono stati utilizzati Spring Boot, Spring Security, Spring Kafka e Spring Jpa.
			\newline
