\subsection{Web application}
	La componente \glock{web app} ha il compito di interfacciare gli utenti con i dispositivi censiti dal sistema e visibili al loro ente di appartenenza.
	\newline
	...
	\newline 
	La componente è stata sviluppata utilizzando i framework \glock{Laravel} e \glock{Vue.js}.
	...
	Nel diagramma delle classi della componente \glock{web app}, rappresentato nel file \textit{Immagini/WebApp-Classi.png}, sono presenti principalmente i provider ed i controller: i provider sono le componenti che effettuano le richieste API da parte della web app e lavorano quindi a basso livello.
	\newline
