\subsection{API}
	...
	\newline
	La componente è stata sviluppata in \glock{Java} 11, utilizzando dei \glock{framework} Spring: Spring boot, Spring security, Spring kafka e Spring jpa; per l'autenticazione web è stato usato Json Web Token.
