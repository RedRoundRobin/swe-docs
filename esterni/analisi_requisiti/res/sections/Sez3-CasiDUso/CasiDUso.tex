\section{Casi d'uso}
	...
	\end{itemize}
		...
		\subsubsection{UC 20 - Nessuna risposta dopo una interazione con \glock{Telegram}}
		\begin{itemize}
		...
		\subsubsection{UC 22 - Visualizzazione errore: username \glock{Telegram} non valido}
		\begin{itemize}
			\item \textbf{Attori Primari}: Utente autenticato.
		...
		\subsubsection{UC 23 - Visualizzazione errore: formato nome o cognome non validi}
		\begin{itemize}
			\item \textbf{Attori Primari}: Utente autenticato.
			...
			\begin{enumerate}
				...
				\item Il sistema elabora la richiesta;
				\item Viene visualizzato un errore che segnala che il nome o il cognome non sono validi.
			\end{enumerate}
		\end{itemize}