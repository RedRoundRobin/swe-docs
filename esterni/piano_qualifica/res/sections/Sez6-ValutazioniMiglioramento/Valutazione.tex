	...
	\subsection{Valutazioni sull'organizzazione}
		...
		\begin{center}
			...
			\begin{longtable}{|p{3cm}|p{6cm}|p{6cm}|}
				...
				Incremento VII
				&
				Durante l'incremento VII non è stato ancora possibile organizzarsi di persona, dal momento l'epidemia COVID-19 ha richiesto misure cautelative in tutta Italia.
			  	&
		 		Al fine di mantenere alta la produttività e la comunicazione con i membri del gruppo, sono stati organizzati con i membri del gruppo degli incontri informali tramite \glock{discord} per fare il punto della situazione all'inizio di ciascun incremento, così da discutere eventuali problematiche riscontrate nel corso dello sviluppo.  \\
				\hline
