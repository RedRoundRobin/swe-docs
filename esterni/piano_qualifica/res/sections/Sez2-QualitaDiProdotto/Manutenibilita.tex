...
Fornisce un indicatore sul livello di semplicità per quanto riguarda la modifica, correzzione ed estendibilità del prodotto software.
	...
	\begin{center}
		\begin{tabular}{|c|c|c|c|c|}
			...
			\hline
			MQ-PROD-7 & Complessità del codice & $\frac{\# linee commento}{\# linee codice}*100$ & NAN & NAN \\
			\hline
			MQ-PROD-8 & Complessità della classe & \textit{\# numero metodi} & NAN & NAN \\
			\hline
			MQ-PROD-9 & Complessità del metodo & $\frac{\# linee codice}{\# chiamate interne ad altri metodi}*100$ & NAN & NAN \\
			\hline
		\end{tabular}
	\end{center}
