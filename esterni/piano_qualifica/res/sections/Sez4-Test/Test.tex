	...
	\subsection{Test di accettazione}
		...
		\begin{center}
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Test di accettazione per i requisiti funzionali %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			 ...
			 %TA-108 & Si verifichi che la documentazione delle API sia stata scritta utilizzata per la denominazione della funzioni messe a disposizione. & I \\
			 %\hline
			 %TA-109 & Si verifichi che il codice sorgente venga gestito tramite un sistema di versionamento. & I \\
			 %\hline
			 %TA-110 & Si verifichi che siano stati realizzati dei test di unità e di integrazione per verificare le singole componenti e i subsystem interni. & I \\
			 %\hline
			 %TA-111 & Si verifichi che la web app superi la validazione W3C & I \\
			 %\hline
	...
	\subsection{Test di sistema}
		\begin{center}
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Test di sistema per i requisiti funzionali %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			 ...
			 %\hline
			 %TSA-F-1.2.1 & Si verifichi che un utente al quale viene chiesto di inserire un codice di autenticazione a due fattori possa richiederne il rinvio & S \\
			 \hline
			 ...
			 %TS-108 & Si verifichi che la documentazione delle API sia stata scritta utilizzata per la denominazione della funzioni messe a disposizione. & S \\
			 %\hline
			 %TS-109 & Si verifichi che il codice sorgente venga gestito tramite un sistema di versionamento. & S \\
			 %\hline
			 %TS-110 & Si verifichi che siano stati realizzati dei test di unità e di integrazione per verificare le singole componenti e i subsystem interni. & S \\
			 %\hline
			 %TS-111 & Si verifichi che la web app superi la validazione W3C & S \\
			 %\hline
			 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Test per i requisiti di vincolo %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
