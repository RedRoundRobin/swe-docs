	...
	\subsection{Test di sistema}
		...
		Riepilogo dei test di sistema
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Test di sistema per i requisiti funzionali %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			 ...
			 \hline
			 TSA-V-7 & Si verifichi che il sistema mostri una correlazione tra almeno due dati. & NI \\
			 \hline
			 TSA-V-8 & Si verifichi che il sistema permetta di visualizzare dati inviati da un dispositivo. & NI \\
			 \hline
			 TSA-V-9 & Si verifichi che il sistema permetta di inviare input ad un dispositivo. & NI \\
			 \hline
			 TSA-V-10 & Si verifichi che il sistema permetta di censire un dispositivo. & NI \\
			 \hline
			 TSA-V-11 & Si verifichi che la web app sia compatibile con il browser \glock{Firefox} dalla versione 69.0. & NI \\
			 \hline
			 TSA-V-12 & Si verifichi che la web app sia compatibile con il browser \glock{Chrome} dalla versione 75.0. & NI \\
			 \hline
			 TSA-V-13 & Si verifichi che la web app sia compatibile con il browser \glock{Safari} dalla versione 13.0. & NI \\
			 \hline
			 TSB-V-14 & Si verifichi che la web app sia compatibile con il browser \glock{Edge} dalla versione 42.0. & NI \\
			 \hline
			 TSA-V-15 & Si verifichi che la web app sia stata sviluppata utilizzando il framework \glock{Bootstrap} & NI \\
			 \hline
			 TSA-V-16 & Si verifichi che tutta la documentazione relativa al software sia stata scritta in lingua italiana. & NI \\
			 \hline
			 TSA-V-16.1 & Si verifichi che il software sia accompagnato da un manuale amministratore, contenente le informazioni utili per la distribuzione e l'installazione del prodotto. & NI \\
			 \hline
			 TSA-V-16.2 & Si verifichi che il software sia accompagnato da un manuale utente, contenente le informazioni utili per l'utilizzo del prodotto da parte degli utenti e dei moderatori ente. & NI \\
			 \hline
